...
const IS_STRUCTURED_STDOUT =
    (typeof _outputFormat === 'string' && _outputFormat !== '' && _outputFormat !== 'text')
    || argv._[0] === 'fetch'
    || argv._[0] === 'jobs';
...
async function main(): Promise<void> {
    try {
        ...
        if (argv._.length > 0 && argv._[0] === 'fetch') {
            ...
            if (!rawMode) fetchEmitter.fetchStart(fetchUrl, method, data !== undefined);
