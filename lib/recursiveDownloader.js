...
class RecursiveDownloader {
    ...
    async downloadDiscoveredFiles(discoveredFiles, baseDestination) {
        ...
        try {
            ...
            const downloadResults = await this.downloadWithCustomPaths(urls, urlToPathMap, this.options.enableResume, this.options.sshOptions, { historyRoot: baseDestination, discovered });
     ...
     */
    async downloadWithCustomPaths(urls, urlToPathMap, enableResume, sshOptions, context = {}) {
        const results = [];
        const stats = {
