...
class IPv6Utils {
     ...
     * @returns Agent options with IPv6 family preference
     */
    static getIPv6AgentOptions(options: Record<string, unknown> = {}): Record<string, unknown> {
        return {
            family: 6, // Force IPv6
            ...options,
        };
     ...
     * @param options - Additional agent options
     * @returns Agent options with dual-stack support
     */
    static getDualStackAgentOptions(options: Record<string, unknown> = {}): Record<string, unknown> {
        return {
