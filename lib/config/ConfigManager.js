    ...
    createValidationSchema() {
        return joi_1.default.object({
            ...
            http: joi_1.default.object({
                ...
                maxConnections: joi_1.default.number().min(1).max(100).default(20),
                userAgent: joi_1.default.string().default('N-Get-Enterprise/2.0'),
                keepAlive: joi_1.default.object({
                    enabled: joi_1.default.boolean().default(true),
                    timeout: joi_1.default.number().min(1000).default(30000),
                    maxSockets: joi_1.default.number().min(1).default(10),
                    maxFreeSockets: joi_1.default.number().min(1).default(5),
                }).default(),
            }).default(),
